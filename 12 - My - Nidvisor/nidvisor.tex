...
\nysida{12}{1}
\noindent
\chaptertitle{M$\mu$}{Nidvisor}
\begin{center}
\Large $\mu1$. Jag har aldrig vart på snusen \\
...
\noindent
\begin{center}
\Large $\mu\pi$. Matematikhatarvisan\\
\mel{Åh, hur saligt att få vandra}
\end{center}
...
Allting blir noll! :$\|$
\begin{flushright}
\textit{Lukas Granqvist, Axel Abrahamsson\\ \sout{Jongasquen} Jonpicknicken 2020}
\end{flushright}
...
\noindent
\begin{center}
\Large $\mu8$. Teknologen och ekonomen\\
\mel{Katyuscha}
\end{center}
