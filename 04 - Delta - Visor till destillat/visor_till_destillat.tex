...
\begin{center}
    ...
    \instruction{\small (bör sjungas med finlänsk brytning. \\ På "Ratataa" drar en i tofsen i mössan.)}
\end{center}
\begin{lyrics}
...
\noindent
\begin{center}
    \songtitle{$\delta14$d}{Självmördarvisan} 
    \mel{Hej tomtegubbar}
\end{center}
\begin{lyrics}
...
&\\
\textbf{\small Osqulda:} &\small Nej, det går inte alls, mitt herrskap, \\ 
