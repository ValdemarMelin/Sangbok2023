...
slår dig för ditt stolta bröst \\och blir så tuff från hår till häl. 
\vspace{5pt}\\
\textbf{Ja, nu skall vi ut och härja...}
\end{lyrics}
...
\begin{center}
   ...
   \small{\textit{Försångare/\textbf{Alla}\\Sjungs lämpligen på småländska.}}% TODO: Digitalize
\end{center}
\begin{figure}[!h]
